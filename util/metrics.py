...
def calc_metrics_at_k(cf_scores, train_user_dict, test_user_dict, user_ids, item_ids, Ks, n_user):
    """
    ...
    for idx, u in enumerate(user_ids):
        ...
        cf_scores[idx][train_pos_item_list-n_user] = -np.inf
        test_pos_item_binary[idx][test_pos_item_list-n_user] = 1
